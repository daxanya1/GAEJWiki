...
public class WikiParserTest {
	...
	public void tetWikiParser3() {
		...
		String resultstr = "<p>test1\ntest2<br /></p>\n<hr class=\"short_line\" />\n<hr class=\"full_hr\" />\n<p>test4<del>test5</del><a id=\"notetext_1\" href=\"#notefoot_1\" class=\"note\" title=\"test6test7\">*1</a>\n<a id=\"notetext_2\" href=\"#notefoot_2\" class=\"note\" title=\"test8test9\">*2</a></p>\n";
		String notestr = "<div id=\"note\"><hr class=\"note_hr\" /><a id=\"notefoot_1\" href=\"#notetext_1\" class=\"note\">*1</a>\n<span class=\"small\">test6<strong>test7</strong></span><br />\n<a id=\"notefoot_2\" href=\"#notetext_2\" class=\"note\">*2</a>\n<span class=\"small\"><em>test8<strong>test9</strong></em></span><br /></div>";
		WikiParser parser = getTestWikiParser();
		String result = parser.parse("reftest", str);
	...
	public void tetWikiParser4() {
		...
		String str = "test1\n*test2%%test3%%[[test4a]] [[test4b]]&br~\ntest5\n*test6\ntest7\n**test8\ntest9\n***test10\ntest11\n#br\ntest12[[test13]]";
		String resultstr = "<p>test1</p>\n<h2 id=\"content_1_0\">test2<del>test3</del><span class=\"noexists\">test4a<a href=\"/edit/test4a?ref=reftest\">?</a></span> <span class=\"noexists\">test4b<a href=\"/edit/test4b?ref=reftest\">?</a></span>&amp;br~  <a class=\"anchor_super\" id=\"id0\" href=\"/view/reftest#id0\" title=\"id0\">&dagger;</a></h2>\n<p>test5</p>\n<div class=\"anchor\"><a href=\"#navigator\">&uarr;</a></div><h2 id=\"content_1_1\">test6  <a class=\"anchor_super\" id=\"id1\" href=\"/view/reftest#id1\" title=\"id1\">&dagger;</a></h2>\n<p>test7</p>\n<div class=\"anchor\"><a href=\"#navigator\">&uarr;</a></div><h3 id=\"content_1_2\">test8  <a class=\"anchor_super\" id=\"id2\" href=\"/view/reftest#id2\" title=\"id2\">&dagger;</a></h3>\n<p>test9</p>\n<div class=\"anchor\"><a href=\"#navigator\">&uarr;</a></div><h4 id=\"content_1_3\">test10  <a class=\"anchor_super\" id=\"id3\" href=\"/view/reftest#id3\" title=\"id3\">&dagger;</a></h4>\n<p>test11</p>\n<div class=\"spacer\">&nbsp;</div>\n<p>test12<span class=\"noexists\">test13<a href=\"/edit/test13?ref=reftest\">?</a></span></p>\n";
		WikiParser parser = getTestWikiParser();
		String result = parser.parse("reftest", str);
		assertEquals(result, resultstr);
	...
	public void tetWikiParser7() {
		...
		String str = ",test1,'''''test2''''',%%test3%%\n, test6((test4)) ,==, '''test5'''";
		String resultstr = "<div class=\"ie5\"><table class=\"style_table\" cellspacing=\"1\" border=\"0\">\n<tr class=\"style_tr\"><td class=\"style_td\">test1</td><td class=\"style_td\"><em><strong>test2</strong></em></td><td class=\"style_td\"><del>test3</del></td></tr>\n<tr class=\"style_tr\"><td class=\"style_td\" style=\"text-align:center\" colspan=\"2\">test6<a id=\"notetext_1\" href=\"#notefoot_1\" class=\"note\" title=\"test4\">*1</a></td><td class=\"style_td\" style=\"text-align:right\"><em>test5</em></td></tr>\n</table></div>\n";
		WikiParser parser = getTestWikiParser();
		String result = parser.parse("reftest", str);
		assertEquals(result, resultstr);
